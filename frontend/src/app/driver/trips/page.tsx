...
function Inner() {
  ...
  return (
    <AppShell tabs={driverTabs} title="Rides">
      <div className="col-span-12">
        <PageIntro title="Rides you scanned" subtitle="A list of students you boarded." />
        <Card className="divide-y divide-slate-100">
          {trips.length === 0 ? (
            <p className="p-8 text-center font-bold text-slate-400">No scans yet.</p>
          ) : (
