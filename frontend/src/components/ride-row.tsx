...
const colors = ["bg-blue-600", "bg-sky-500", "bg-indigo-600"];
  ...
  return (
    <article className="flex items-center justify-between p-3.5 transition hover:bg-slate-50">
      <div className="flex items-center space-x-3">
        <div
          className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-white ${colors[index % colors.length]}`}
        >
